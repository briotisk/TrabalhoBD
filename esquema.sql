...
CREATE TABLE NAVE(
	...
	VELOCIDADEMAX NUMBER(6) NOT NULL,
...
CREATE TABLE VIAJAM(
    ...
    CONSTRAINT FK2_VIAJAM FOREIGN KEY (NAVE)
               REFERENCES VIAGEM(NAVE)
               ON DELETE CASCADE
    CONSTRAINT FK3_VIAJAM FOREIGN KEY (DATA_HORA)
               REFERENCES VIAGEM(DATA_HORA)
               ON DELETE CASCADE
);
...
CREATE TABLE INSTALACAO(
    ...
    CUSTO_CONSTRUCAO INTEGER NOT NULL, 
...
CREATE TABLE VIAGEM(
    ...
    PRECO_PASSAGEM NUMERIC(6,2) NOT NULL,
    ...
    CONSTRAINT CK2_VIAGEM CHECK(DISTANCIA < obter_valor(NAVE)),
